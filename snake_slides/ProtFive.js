...
const venom = require('../images/king_cobra2.png');

export const ProtFive = () => { 
    ...
    <View style={styles.container} onTouchStart={() => {
        ...
        <View style={styles.background}>
                <Text style={styles.titleText}>Proteroglyphous: Venom Type and Function</Text> 
        </View>
        <View style={styles.imageView}>
            ...
            <View style={{width: '60%'}}>
                <Text style={styles.thankText}>Most snakes that have proteroglyphous fangs have venom that contains neurotoxins.  Neurotoxins directly destroy nerve tissues, causing the victim to become paralyzed and are significantly quicker to immobilizing prey than hemotoxins.  Because of this ability to quickly subdue prey, most Elapids are active hunters instead of ambush predators. </Text>
            </View>
        </View>
